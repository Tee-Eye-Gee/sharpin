...
Deno.serve(async (req: Request) => {
  ...
  // to the caller) rather than a real 500 the client can branch on. Live-
  // reproduced and confirmed as the actual cause of the "Something went
  ...
  try {
    ...
    console.error('unhandled exception in create-account:', err)
